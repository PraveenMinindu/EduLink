...
class ProcessingScreen extends StatefulWidget {
  ...
  const ProcessingScreen({super.key, required this.studentId, required this.assessmentId});
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          // Navigate to report when done — guarded to fire only once
            ...
            WidgetsBinding.instance.addPostFrameCallback((_) {
              if (mounted) {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (_) => ReportScreen(studentId: widget.assessmentId),
                  ),
                );
              }
            });
