...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  CareerReport get report => widget.report;
  ...
  Future<void> _loadHistory() async {
    final history = await AuthService.getAssessmentHistory(widget.studentId);
    if (mounted) {
      setState(() {
        _history = history;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                            ...
                            onPressed: () => Navigator.pushAndRemoveUntil(
                              ...
                              MaterialPageRoute(
                                builder: (_) => MCQScreen(
                                  studentId: studentId,
                                  assessmentId:
                                      AuthService.generateAssessmentId(
                                        studentId,
                                      ),
                                ),
                              ),
                  ...
                  // Assessment history — from Firestore
                  Container(
  ...
  Widget _historyItem({
    ...
    onTap: assessmentId.isNotEmpty
        ? () => Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => ReportScreen(studentId: assessmentId),
            ),
          )
        : null,
    child: Row(
      children: [
        ...
        if (assessmentId.isNotEmpty)
          const Padding(
            ...
            child: Icon(Icons.chevron_right, size: 16, color: AppColors.text3),
          ),
      ],
    ),
  );
