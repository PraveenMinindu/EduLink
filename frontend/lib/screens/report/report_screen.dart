...
// ── Reasoning Detail Screen ───────────────────────────────────
class _ReasoningScreen extends StatelessWidget {
  ...
  static const _sectionIcons = {
    'career_match': Icons.star_outline,
    'evidence': Icons.analytics_outlined,
    'psychological': Icons.psychology_outlined,
    'writing_readiness': Icons.edit_note_outlined,
    'market_context': Icons.trending_up_outlined,
    'development_areas': Icons.build_outlined,
    'education_path': Icons.school_outlined,
    'overall': Icons.lightbulb_outline,
  };

  static const _sectionColors = {
    'career_match': AppColors.navy,
    'evidence': AppColors.blue,
    'psychological': Color(0xFF8B5CF6),
    'writing_readiness': AppColors.mint,
    'market_context': AppColors.gold,
    'development_areas': AppColors.rose,
    'education_path': AppColors.blue,
    'overall': AppColors.navy,
  };

  Color _confidenceColor() {
    if (confidenceLabel == 'High') return AppColors.mint;
    if (confidenceLabel == 'Medium') return AppColors.gold;
    return AppColors.rose;
  }
        ...
        children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                          color: _confidenceColor().withOpacity(0.5),
                        ),
                      ),
                      child: Text(
                        "$confidenceLabel  •  ${finalScore.toStringAsFixed(1)}/100",
                        style: TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.w700,
                          color: _confidenceColor(),
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: hasSections ? _buildSections() : [_buildFallback()],
              ),
            ),
          ),
        ],
  ...
  List<Widget> _buildSections() {
    ...
    sections.forEach((key, value) {
      if (value is Map) {
        ...
        if (text.isNotEmpty) {
          widgets.add(_sectionCard(key, title, text));
